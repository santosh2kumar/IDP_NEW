...
def train_test_preprocess(train_df, fd_001_test):
    return dsl.ContainerOp(
        ...
        image='sachin944/nasa:step2_rf_xgb',
        arguments=[
            '--train_df', train_df,
...
def train_test_preprocess_lstm(train_df, fd_001_test, unit_number, RUL):
    return dsl.ContainerOp(
        ...
        image='sachin944/nasa:step2_lstmv3',
        arguments=[
            '--train_df', train_df,
            '--fd_001_test', fd_001_test,
...
def train_xgb(X, Y):
    return dsl.ContainerOp(
        ...
        image='sachin944/nasa:step3_xgb',
        arguments=[
            '--X', X,
            '--Y', Y
        ],
...
def train_lstm(seq_array, label_array):
    ...
    return dsl.ContainerOp(
        name='Train LSTM RNN',
        image='sachin944/nasa:step3_lstmv4',
        arguments=[
            '--seq_array', seq_array,
...
def test_xgb(model_xgb, X_001_test):
    ...
    return dsl.ContainerOp(
        ...
        image='sachin944/nasa:step4_xgbb',
        arguments=[
            '--model_xgb', model_xgb,
            '--X_001_test', X_001_test
        ],
...
def test_lstm(model_lstm, test_df):
    return dsl.ContainerOp(
        name='Test LSTM',
        image='sachin944/nasa:step4_lstm',
        arguments=[
