...
parser.add_argument('--model_xgb')
parser.add_argument('--X_001_test')

args = parser.parse_args()

xgb_f = open(args.model_xgb,'rb')
model_xgb = pickle.load(xgb_f)
